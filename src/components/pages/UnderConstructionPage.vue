...
const duration = 20 * 24 * 60 * 60 * 1000; // 20 days in milliseconds
...
<template>
    <AuthBackground>
    <section class="under-construction relative flex flex-col items-center md:justify-center pt-24 md:pt-0 overflow-hidden mx-5 mt-10 mb-20 md:my-12 h-[45rem] md:h-[45rem] md:rounded-none md:max-w-screen-md md:mx-auto lg:mx-auto lg:max-w-screen-lg">
