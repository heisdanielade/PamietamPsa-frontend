    ...
    <section class="explore overflow-hidden mt-11 bg-purple-50 " id="explore">
        <div class="select-none pt-16 pb-16">
            <div class="header text-center flex flex-col items-center justify-center w-full">
                ...
                <p class="text-xs ml-8 mr-8 text-wrap lg:text-[0.9rem] text-gray-500 mt-4">
            ...
            <div class="features flex flex-wrap justify-center items-center gap-4 mt-10">
                <div class="card custom-cursor lg:mr-4 p-2 bg-white text-center flex flex-col items-center justify-center w-[10rem] h-[12rem] rounded-[1.25rem]">
                ...
                <div class="card custom-cursor lg:mr-4 p-2 bg-purple-400 text-center flex flex-col items-center justify-center w-[10rem] h-[12rem] rounded-[1.25rem]">
                ...
                <div class="card custom-cursor p-2 bg-white text-center flex flex-col items-center justify-center w-[10rem] h-[12rem] rounded-[1.25rem]">
