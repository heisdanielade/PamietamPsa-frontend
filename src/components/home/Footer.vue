        ...
        <div v-scroll-reveal class="not-shown w-full max-w-screen-lg mx-auto p-4 md:py-8">
            <div class="sm:flex sm:items-center sm:justify-between">
                ...
                <ul
                    ...
                    <li>
                        <a href="https://heisdanielade.xyz" target="_blank" class="hover:text-purple-500 transition">Developer</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                ...
                <div class="flex mt-4 sm:justify-center sm:mt-0">
                    ...
                    <router-link to="#" class="text-purple-500 hover:text-gray-500 transition ms-5">
                        <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 21 16">
                            <path
