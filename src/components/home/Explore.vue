    ...
    <section class="explore overflow-hidden mt-24 md:mt-28 bg-purple-50" id="explore">
        <div class="select-none pt-16 pb-16">
            ...
            <div class="features flex flex-wrap justify-center items-center gap-[1.05rem] md:gap-7 lg:gap-10 mt-12 px-2">
                ...
                <div v-scroll-reveal class="xnot-shown card lg:scale-110 custom-cursor p-2 bg-purple-400 text-center flex flex-col items-center justify-center w-[10rem] h-[12rem] rounded-[1.25rem]">
