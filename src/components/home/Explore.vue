    ...
    <section class="explore overflow-hidden mt-11 bg-purple-50 " id="explore">
        <div class="select-none pt-16 pb-16">
            ...
            <div class="features flex flex-wrap justify-center items-center gap-4 mt-10">
                <div v-scroll-reveal class="not-shown card lg:scale-110 custom-cursor md:mr-5 p-2 bg-white text-center flex flex-col items-center justify-center w-[10rem] h-[12rem] rounded-[1.25rem]">
                ...
                <div v-scroll-reveal class="not-shown card lg:scale-110 custom-cursor md:mr-5 p-2 bg-purple-400 text-center flex flex-col items-center justify-center w-[10rem] h-[12rem] rounded-[1.25rem]">
