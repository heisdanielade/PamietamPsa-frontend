    ...
    <section class="explore overflow-hidden mt-11 bg-purple-50" id="explore">
        <div class="select-none pt-16 pb-16">
            <div class="header text-center flex flex-col items-center justify-center w-full">
                <h1 v-scroll-reveal class="not-shown text-3xl gradient-text-1 font-bold w-full lg:text-5xl md:text-4xl">
                    Explore our features
                </h1>
                <p v-scroll-reveal class="not-shown font-medium text-xs ml-8 mr-8 text-wrap lg:text-[0.9rem] text-gray-500 mt-4">
            ...
            <div class="features flex flex-wrap justify-center items-center gap-[1.125rem] md:gap-7 lg:gap-10 mt-10 px-2">
                <div v-scroll-reveal class="not-shwn card lg:scale-110 custom-cursor md:mr-5x p-2 bg-white text-center flex flex-col items-center justify-center w-[10rem] h-[12rem] rounded-[1.25rem]">
                ...
                <div v-scroll-reveal class="not-shwn card lg:scale-110 custom-cursor md:mr-5x p-2 bg-purple-400 text-center flex flex-col items-center justify-center w-[10rem] h-[12rem] rounded-[1.25rem]">
