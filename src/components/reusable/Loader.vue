<template>
  <div class="flex flex-col items-center justify-center h-screen bg-white animate-fadeIn">
    <Logo/>

    <div class="loader my-7"></div>

    <p class="text-gray-600 italic text-sm select-none">
      Fetching tails & treats...
    </p>
  </div>
</template>
